...
export default function DesktopCalendar({
    ...
    const revealDesktopEventRoute = useCallback(
        (
            ...
            const requestedPath = normalizeDesktopEventPath(
                route.relativePath
            );
    ...
    const changeView = useCallback(
        ...
        [dayCount, isAndroid, persistPreferences, preferences, setViewType]
    );
    ...
    const changeDayCount = useCallback(
        ...
        [isAndroid, persistPreferences, preferences, setDaysCount]
    );
