...
import "./androidTimeGridBoundary";
...
function showFatalError(error: unknown): void {
    ...
    document.body.innerHTML = `
        <main style="box-sizing:border-box;min-height:100vh;padding:24px;background:#11111b;color:#cdd6f4;font-family:system-ui,sans-serif;overflow:auto">
            ...
            <pre style="white-space:pre-wrap;overflow-wrap:anywhere;padding:14px;border-radius:12px;background:#1e1e2e;color:#f38ba8;font-size:12px;line-height:1.45">${message.replace(/[&<>"']/g, character => ({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"}[character] ?? character))}</pre>
        </main>`;
}
