...
export function MapPinIcon({ size = 16 }: { size?: number }) {
    // Lucide MapPin — le lieu d'un evenement. A ne pas confondre avec
    // `PinIcon`, qui est la punaise Lucide Pin et designe tout autre chose :
    // epingler un evenement dans la liste.
    return (
        <svg
            width={size}
            height={size}
...
/** Lucide RefreshCw — the ICS panel's manual "Refresh now" action. */
export function RefreshCwIcon({ size = 15 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
/** Lucide Trash2 — removes an ICS link (its already-created notes stay put). */
export function Trash2Icon({ size = 15 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
/** Lucide AlertCircle — an ICS link's failed-sync state. */
export function AlertCircleIcon({ size = 15 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
/** Lucide Loader2 — an ICS link currently syncing. Spun by CSS. */
export function Loader2Icon({ size = 15 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
