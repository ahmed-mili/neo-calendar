...
/*
 * Lucide « refresh-ccw », l'icone qu'Ahmed a fournie pour la repetition.
 *
 * Dessinee sur la grille 24 de Lucide plutot que sur celle de 16 des icones
 * voisines : c'est le trace officiel, et le redessiner a 16 en aurait fait un
 * sosie. A 16 px de large, un trait de 2 sur 24 retombe sur 1,33 px — la meme
 * epaisseur apparente que le 1,3 des icones dessinees ici.
 *
 * Elle remplace une silhouette pleine qui etait la seule icone remplie du
 * panneau : au trait, elle se pose enfin comme ses voisines et suit
 * `currentColor` du texte a cote duquel elle est.
 */
