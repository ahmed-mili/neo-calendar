...
const FR: Record<string, string> = {
    ...
    "At the prayer": "À l'heure de la prière",
    "Followed mosque": "Mosquée suivie",
    Reminders: "Rappels",
    ...
    "Choose how to apply these changes.":
        "Choisissez comment appliquer ces modifications.",
    ...
    "Drag onto the grid to add a date":
        "Glissez sur la grille pour ajouter une date",
    ...
    "Calendar name (optional)": "Nom du calendrier (facultatif)",
    "Import a rules JSON": "Importer un JSON de règles",
    Preset: "Modèle",
    Colour: "Couleur",
    "Add the calendar": "Ajouter le calendrier",
    "Adding…": "Ajout…",
    "Remove the empty calendar folder": "Retirer le dossier de calendrier vide",
    "Remove the read-only calendar": "Retirer le calendrier en lecture seule",
    "Neo Calendar encountered an interface error.":
        "Neo Calendar a rencontré une erreur d’interface.",
    "Reload interface": "Recharger l’interface",
    Confirm: "Confirmer",
    ...
    "Show only this link": "Afficher seulement ce lien",
    "Stop isolating": "Ne plus isoler",
